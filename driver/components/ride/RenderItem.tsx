...
import { rideDataTypes, rideIcons } from "@/configs/constants";
    ...
    <View style={styles.main}>
      ...
      >
        <View style={styles.cardTop}>
            <View>
          /* This part of the code is rendering a text component 
          with dynamic content based on the
          `item.title` value. Here's a breakdown of what it does: */
            <Text style={styles.data}>
              {item.title === "Total Earning"
                ? driver?.totalEarning + " NGN"
